                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane <?php echo $templates_tab_active ?>" id="templates-tab">
                                            ...
                                            <div class="text-center--">
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=request_for_approval_approval&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Request for proposal approval'); ?></button>
