                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item "><a class="<?php echo $email_tab_active ?> nav-link" href="#email-tab" data-toggle="tab"><i class="fa fa-envelope"></i></a></li>
                                        <li class="nav-item "><a class="<?php echo $templates_tab_active ?> nav-link" href="#templates-tab" data-toggle="tab"><i class="fa fa-bell"></i></a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane <?php echo $templates_tab_active ?>" id="templates-tab">
                                            ...
                                            <div class="text-center--">
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=survey&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Survey Invitation'); ?></button>
                                                ...
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=leave_request&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Leave Request'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=leave_form_update&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Leave form update'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=form_signatory_request&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Form signatory request'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=project_assignment&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Project assignment'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=depreciated_assets&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Depreciated Assets'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=requisition_approval_request&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Requisition Approval Request'); ?></button>
                                                <button onClick='showModal("index.php?modal=notifications/edit&reroute=<?php echo $crypt->encode('page=' . $_GET['page'] . '&tab=templates-tab') ?>&code=requisition_status_update&tab=templates-tab");return false' data-toggle="modal" class="btn btn-primary btn-sm mt-2 mr-2"><?php _e('Requisition Status Update'); ?></button>
                                            </div>
