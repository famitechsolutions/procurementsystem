                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-title">
                                    Bids
                                    <?php if (in_array("createBid", $user_permissions)) { ?><button onclick='showModal("index.php?modal=bids/add&reroute=<?php echo $crypt->encode('page=' . $_GET['page']) ?>", "large");return false' class="btn btn-primary btn-xs pull-right">New Bid</button><?php } ?>
                                </div>
                                <div class="card-body">
                                    <?php
                                    $queryCondition = "";
