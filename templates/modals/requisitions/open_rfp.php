...
<div class="modal-header">
    ...
    <div class="modal-body">
        <p class="alert alert-warning fa fa-warning"> Once opened, there will be no more edits and adding attachments, and interested vendors will be allowed to submit their proposals</p>
