...
<div class="modal-header">
    <h4 class="modal-title">Deleting Requisition</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
    <div class="modal-body">
        <p class="alert alert-warning fa fa-warning"> The Items will be permanently removed. And all items that are attached to this requisition will all be deleted</p>
        <input type="hidden" name="action" value="deleteRequisition">
