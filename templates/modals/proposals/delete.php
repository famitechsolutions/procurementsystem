...
<div class="modal-header">
    ...
    <div class="modal-body">
        <p class="alert alert-warning fa fa-warning"> The Items will be permanently removed. And all items that are attached to this request will all be deleted</p>
        <input type="hidden" name="action" value="deleteRFP">
